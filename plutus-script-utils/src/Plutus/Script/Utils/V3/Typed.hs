...
type CertifyingPurposeType a =
  CertifyingPurposeType' (CertifyingRedeemerType a) (CertifyingTxInfoType a)
...
type ProposingPurposeType a =
  ProposingPurposeType' (ProposingRedeemerType a) (ProposingTxInfoType a)

-- | Rewarding scripts take a credential, redeemer and txInfo
type RewardingPurposeType' red txInfo = Credential -> red -> txInfo -> Bool

type RewardingPurposeType a =
  RewardingPurposeType' (RewardingRedeemerType a) (RewardingTxInfoType a)
...
type SpendingPurposeType a =
  SpendingPurposeType' (SpendingDatumType a) (SpendingRedeemerType a) (SpendingTxInfoType a)
